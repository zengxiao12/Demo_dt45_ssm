...
<div class="right">
     ...
     <div class="providerAdd">
         ...
         <form method="post" id="billForm" name="billForm"  action="${pageContext.request.contextPath }/addBill">
             ...
             <div>
                 ...
                 <input type=number name="productCount" id="productCount"> 
				 <font color="red"></font>
             </div>
             <div>
             ...
             <div>
                 ...
                 <select name="providerId" id="providerId">
                 	<c:forEach items="${listsp }" var="sp">
                 		<option value="${sp.id }">${sp.proname }</option>
                 	</c:forEach>
		         </select>
				 <font color="red"></font>
             </div>
